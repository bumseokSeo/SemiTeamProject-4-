...
<!-- bootstrap -->
  ...
  $(function(){
		//댓글 목록 가져오기 함수
		function reviewListAll(){ //현재글의 댓글을 모두 가져오기
			var url = "/myapp/review/list";
			var params = "placeid=${vo.placeid}";
			$.ajax({
				url:url,
				data:params,
...
<body id="body-pd">
	...
	<div class="map_wrap" style="position: relative;">
		...
		<div id="review" style="margin: 2px; border: solid #20B2AA; float: left; display: block; width: 450px; height: 100%; position: relative; background-color: white; z-index: 1;">
			<hr />
